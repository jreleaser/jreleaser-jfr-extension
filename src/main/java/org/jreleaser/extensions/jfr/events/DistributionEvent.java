...
public class DistributionEvent extends Event {
    ...
    public static void startDistribution(Distribution distribution) {
        DistributionEvent event = new DistributionEvent();
        event.kind = "START";
        event.name = distribution.getName();
        event.type = distribution.getType().toString();
        event.commit();
    }

    public static void endDistribution(Distribution distribution) {
        DistributionEvent event = new DistributionEvent();
        event.kind = "END";
        event.name = distribution.getName();
        event.type = distribution.getType().toString();
